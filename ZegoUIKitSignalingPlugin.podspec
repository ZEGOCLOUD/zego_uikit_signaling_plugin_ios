#
#  Be sure to run `pod spec lint ZegoUIKitSignalingPlugin.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = "ZegoUIKitSignalingPlugin SDK for iOS by ZEGO."
  ...
  spec.source_files =  "ZegoUIKitSignalingPlugin","ZegoUIKitSignalingPlugin/**/*.{swift}"
  ...
  spec.dependency 'ZIM', '2.13.1'
  spec.dependency 'ZPNs', '2.6.0'
